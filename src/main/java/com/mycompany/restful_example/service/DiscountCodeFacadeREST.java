...
import com.mycompany.restful_example.DiscountCode;
 ...
 */
@Stateless
@Path("com.mycompany.restful_example.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {
    @PersistenceContext(unitName = "com.mycompany_RestFul_Example_war_1.0-SNAPSHOTPU")
